...
const DESKTOP_RELEASES_URL = 'https://github.com/nabil-anis/worldmonitor-by-nbl/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/nabil-anis/worldmonitor-by-nbl/discussions/94" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
